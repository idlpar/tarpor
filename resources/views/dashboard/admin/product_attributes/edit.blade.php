        ...
        <div class="max-w-xl mx-auto bg-white p-8 rounded-lg shadow-lg">
            <form action="{{ route('product_attributes.update', $product_attribute->id) }}" method="POST">
                ...
                <div class="mb-5">
                    ...
                    <input type="text" id="name" name="name" value="{{ old('name', $product_attribute->name) }}" class="block w-full px-4 py-2 bg-gray-50 border border-gray-300 rounded-md shadow-sm placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-200" placeholder="e.g., Size, Color, Material">
                    @error('name')
