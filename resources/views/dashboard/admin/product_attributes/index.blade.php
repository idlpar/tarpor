                            ...
                            <tr class="hover:bg-gray-50 transition-colors duration-200">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex items-center justify-end space-x-2">
                                        <a href="{{ route('product_attributes.edit', $attribute->id) }}" class="text-blue-600 hover:text-blue-900 p-1 rounded-md hover:bg-gray-100" title="Edit Attribute">
                                        ...
                                        <form action="{{ route('product_attributes.destroy', $attribute->id) }}" method="POST" class="delete-attribute-form inline-block">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="text-red-600 hover:text-red-900 p-1 rounded-md hover:bg-gray-100" title="Delete Attribute">
