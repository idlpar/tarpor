        ...
        <div class="max-w-xl mx-auto bg-white p-8 rounded-lg shadow-lg">
            ...
            <form action="{{ route('product_attributes.store') }}" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <input type="text" id="name" name="name" value="{{ old('name') }}" class="w-full border border-gray-300 p-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 @error('name') border-red-500 @enderror" placeholder="e.g., Size, Color, Material">
                    @error('name')
