...
@section('content')
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="max-w-xl mx-auto bg-white p-8 rounded-lg shadow-lg">
            <h1 class="text-3xl font-bold mb-6 text-gray-800">Edit Value for {{ $attribute->name }}</h1>
            ...
            <form action="{{ route('product_attributes.values.update', ['product_attribute' => $attribute->id, 'value' => $value->id]) }}" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <input type="text" id="value" name="value" value="{{ old('value', $value->value) }}" class="w-full border border-gray-300 p-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 @error('value') border-red-500 @enderror" placeholder="e.g., Red, Small, Cotton">
                    @error('value')
