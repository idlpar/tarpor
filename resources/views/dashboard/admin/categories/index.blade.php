                            ...
                            <tr class="hover:bg-gray-50">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        <div class="flex-shrink-0 h-10 w-10 rounded-md bg-gray-100 flex items-center justify-center">
                                            @if($category->image)
                                                <img class="h-10 w-10 rounded-md object-cover" src="{{ $category->image }}" alt="{{ $category->name }}">
                                            @else
                                        ...
                                        <div class="ml-4">
                                            ...
                                            @if($category->parent)
                                                <div class="text-xs text-gray-500">Child of {{ $category->parent->name }}</div>
                                            @endif
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex items-center justify-end space-x-2">
                                        <a href="{{ route('categories.show', $category->id) }}" class="text-blue-600 hover:text-blue-900" title="View">
            ...
            deleteForms.forEach(form => {
                form.addEventListener('submit', function(e) {
                    ...
                    Swal.fire({
                        ...
                        focusCancel: true,  // Makes Cancel the focused button by default
                        reverseButtons: true,  // Shows Cancel first (on the left)
                        backdrop: `
                            rgba(0,0,123,0.4)
