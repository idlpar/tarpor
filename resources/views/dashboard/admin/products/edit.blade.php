            ...
            <form action="{{ route('products.update', $product->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <x-form.file-upload
                        ...
                        :existingImages="$product->getGalleryImagesAttribute()"
                        multiple
                        description="(Please remove your previous product image before uploading new image or images)"
                    />
                    <x-form.file-upload name="thumbnail_new" label="Thumbnail Image" uploadLabel="Upload Thumbnail Images" isSingleImage="true" :existingImages="$product->getThumbnailUrlAttribute()" />
