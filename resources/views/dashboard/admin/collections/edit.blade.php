...
@section('admin_content')
    <div class="container mx-auto px-4 py-4">
        ...
        <x-ui.page-header title="Edit Collection" description="Update the details of the collection.">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            const checkSlug = debounce(async (slugToCheck, isManual = false) => {
                ...
                try {
                    const response = await fetch(`/api/collection/slug/check?name=${encodeURIComponent(slugToCheck)}&id={{ $collection->id }}`);
                    if (!response.ok) {
