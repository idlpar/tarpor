        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-8">
            <div class="mb-4 md:mb-0">
                <div class="flex items-center">
                    ...
                    <div>
                        <h1 class="text-3xl font-bold text-gray-900 tracking-tight">Create New Collection</h1>
                        <p class="mt-1 text-sm text-gray-600">Organize your products into collections</p>
                    </div>
                </div>
            </div>
            <div>
