...
@section('admin_content')
    ...
    <div class="container mx-auto px-4 py-6">
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-8">
            <div class="mb-4 md:mb-0">
                <div class="flex items-center">
                    ...
                    <div>
                        <h1 class="text-3xl font-bold text-gray-900 tracking-tight">Edit FAQ</h1>
                        <p class="mt-1 text-sm text-gray-600">Modify the details of an existing frequently asked question</p>
                    </div>
                </div>
            </div>
            <div>
        ...
        <div class="bg-white shadow-lg rounded-lg p-8">
            <h2 class="text-3xl font-bold mb-6 text-gray-800">Edit FAQ</h2>
            ...
            <form action="{{ route('faqs.update', $faq->id) }}" method="POST">
                ...
                <div class="mb-5">
                    ...
                    <input type="text" name="question" id="question" class="block w-full px-4 py-2 bg-gray-50 border border-gray-300 rounded-md shadow-sm placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-200" value="{{ old('question', $faq->question) }}" required placeholder="Enter the FAQ question">
                </div>
                <div class="mb-5">
                    <label for="answer" class="block text-sm font-semibold text-gray-700 mb-2">Answer</label>
                    <textarea id="answer" name="answer" rows="5" class="block w-full px-4 py-2 bg-gray-50 border border-gray-300 rounded-md shadow-sm placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-200" placeholder="Enter FAQ answer" required>{{ old('answer', $faq->answer) }}</textarea>
                </div>
