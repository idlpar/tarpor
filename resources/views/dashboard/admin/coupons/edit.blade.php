...
@section('admin_content')
    <div class="container mx-auto px-4 py-4">
        ...
        <x-ui.page-header title="Edit Coupon" description="Update the details of the coupon.">
                    ...
                    <x-ui.content-card class="p-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="number" name="value" id="value" step="0.01" value="{{ old('value', $coupon->value) }}" class="block w-full px-4 py-2 bg-gray-50 border border-gray-300 rounded-md shadow-sm placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-200" required placeholder="e.g., 10.00 or 20">
                            </div>
                            <div>
