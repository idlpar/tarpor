...
@section('admin_content')
    <div class="container mx-auto px-4 py-4">
        ...
        <x-ui.page-header title="Edit Product Specification Group" description="Update the details of the specification group.">
        ...
        <form action="{{ route('admin.product_specifications.groups.update', $group) }}" method="POST">
            @csrf
            @method('PUT')
