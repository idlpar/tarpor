...
@push('styles')
    <style>
        ...
        @keyframes glow {
            ...
            50% { text-shadow: 0 0 20px rgba(96, 165, 250, 1); }
        }
...
@section('content')
    <div class="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 to-gray-800">
        ...
        <div class="text-center max-w-2xl px-4 relative z-10">
            ...
            <p class="text-2xl mt-6 font-light text-gray-300">Access Forbidden</p>
            ...
            <div class="mt-8">
                <a href="{{ route('home') }}" class="inline-block px-8 py-3 bg-gradient-to-r from-blue-600 to-teal-600 text-white font-semibold uppercase rounded-lg shadow-lg hover:from-blue-700 hover:to-teal-700 hover:shadow-xl transition-all duration-300">
                    Return Home
                </a>
            </div>

            <div class="mt-12">
                <svg class="w-24 h-24 mx-auto text-blue-500 opacity-50" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        (function () {
            ...
            class ParticleNetwork {
                constructor(container, options) {
                    ...
                    this.options = {
                        particleColor: options.particleColor || '#3b82f6', // Blue color for particles
