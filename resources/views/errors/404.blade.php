...
@push('styles')
    <style>
        ...
        /* Glowing animation */
        @keyframes glow {
            0%, 100% { text-shadow: 0 0 10px rgba(192, 132, 252, 0.8); }
            50% { text-shadow: 0 0 20px rgba(192, 132, 252, 1); }
        }
        ...
        .animate-gradient-shift {
            background: linear-gradient(-45deg, #6d28d9, #db2777, #6d28d9, #db2777);
        ...
        .animate-rotate {
            background: linear-gradient(-45deg, #8a2be2, #ff1493, #8a2be2, #ff1493);
            background-size: 200% 200%;
...
@section('title', '404 - Not Found | ' . strtoupper(config('app.name')))
...
@section('content')
    <div class="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 to-gray-800">
        ...
        <div class="text-center max-w-2xl px-4 relative z-10">
            ...
            <p class="text-2xl mt-6 font-light text-gray-300">Page Not Found</p>
            ...
            <div class="mt-8">
                <a href="{{ route('home') }}" class="inline-block px-8 py-3 bg-gradient-to-r from-purple-600 to-pink-600 text-white font-semibold uppercase rounded-lg shadow-lg hover:from-purple-700 hover:to-pink-700 hover:shadow-xl transition-all duration-300">
                    Return Home
                </a>
            </div>

            <div class="mt-12">
                <svg class="w-24 h-24 mx-auto text-purple-500 opacity-50" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
