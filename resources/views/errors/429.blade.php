...
@push('styles')
    <style>
        ...
        /* Glowing animation */
        @keyframes glow {
            0%, 100% { text-shadow: 0 0 10px rgba(239, 68, 68, 0.8); }
...
@section('content')
    <div class="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 to-gray-800">
        ...
        <div class="text-center max-w-2xl px-4 relative z-10">
            ...
            <p class="text-2xl mt-6 font-light text-gray-300">Too Many Requests</p>
            ...
            <div class="mt-8">
                <a href="{{ route('home') }}" class="inline-block px-8 py-3 bg-gradient-to-r from-red-600 to-orange-600 text-white font-semibold uppercase rounded-lg shadow-lg hover:from-red-700 hover:to-orange-700 hover:shadow-xl transition-all duration-300">
                    Try Again
                </a>
            </div>

            <div class="mt-12">
                <svg class="w-24 h-24 mx-auto text-red-500 opacity-50" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        (function () {
            ...
            class ParticleNetwork {
                constructor(container, options) {
                    ...
                    this.options = {
                        particleColor: options.particleColor || '#ef4444', // Red color for particles
            ...
            const options = {
                particleColor: '#ef4444', // Red color for particles
