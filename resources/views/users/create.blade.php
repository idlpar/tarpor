                ...
                <div class="mb-4 md:mb-0">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-sm text-gray-600">Register a new user account with appropriate permissions</p>
                        </div>
                    </div>
                </div>
                <div>
            ...
            <div class="bg-white shadow-lg rounded-xl overflow-hidden border border-gray-200">
                ...
                <div class="bg-gradient-to-r from-[var(--primary)] to-[var(--primary-dark)] px-6 py-4">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <h2 class="text-xl font-semibold text-white">New User Registration</h2>
                            <p class="text-sm text-white text-opacity-90">Complete all required fields</p>
                        </div>
                    </div>
                </div>

                <!-- Form Content -->
                <div class="p-6 bg-gradient-to-r from-blue-100 via-teal-100 to-green-100">
                        ...
                        <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <div class="relative rounded-md shadow-sm">
                                        ...
                                        <input type="password" name="password" id="password"
                                               class="focus:ring-[var(--primary)] focus:border-[var(--primary)] block w-full pl-10 py-2 sm:text-sm border-gray-300 rounded-md @error('password') border-red-300 @enderror"
                                               placeholder="••••••••">
                                    </div>
                                ...
                                <div>
                                    ...
                                    <div class="relative rounded-md shadow-sm">
                                        ...
                                        <input type="password" name="password_confirmation" id="password_confirmation"
                                               class="focus:ring-[var(--primary)] focus:border-[var(--primary)] block w-full pl-10 py-2 sm:text-sm border-gray-300 rounded-md"
                                               placeholder="••••••••">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <select name="role" id="role"
                                        class="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-[var(--primary)] focus:border-[var(--primary)] sm:text-sm rounded-md @error('role') border-red-300 @enderror">
                                    <option value="">Select a role</option>
                                    <option value="admin" {{ old('role') == 'admin' ? 'selected' : '' }} class="text-purple-800">Admin</option>
                                    <option value="staff" {{ old('role') == 'staff' ? 'selected' : '' }} class="text-blue-800">Staff</option>
                                    <option value="user" {{ old('role') == 'user' ? 'selected' : '' }} class="text-green-800">User</option>
                                </select>
                                @error('role')
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                @enderror
