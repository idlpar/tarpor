                        ...
                        @forelse ($orders as $order)
                            <tr class="hover:bg-blue-50 transition duration-150">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    @can('view', $order)
                                        <a href="{{ route('orders.show', $order) }}" class="text-[var(--primary)] hover:text-[var(--primary-dark)] mr-3" title="View Order">
                                    ...
                                    @endcan
                                    @can('update', $order)
                                        <a href="{{ route('orders.edit', $order) }}" class="text-[var(--primary)] hover:text-[var(--primary-dark)] mr-3" title="Edit Order">
                                            <svg class="h-5 w-5 inline" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
