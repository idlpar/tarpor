            ...
            <form class="mt-8 space-y-6" method="POST" action="{{ route('password.change') }}">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        >
                        <span id="toggle-current-password" class="absolute inset-y-0 right-0 pr-3 flex items-center cursor-pointer">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        >
                        <span id="toggle-new-password" class="absolute inset-y-0 right-0 pr-3 flex items-center cursor-pointer">
                                <x-icon name="icon-eye" class="h-7 w-7" />
                        </span>
                    </div>
