    ...
    <div class="nav-container py-4 px-4 sm:px-6 shadow-lg bg-gray-950 ">
        <div class="container mx-auto flex items-center justify-between">
            ...
            <div class="flex items-center space-x-4 sm:space-x-6">
                ...
                <a href="{{ route('cart.index') }}" class="cart-icon hidden md:flex relative text-white hover:text-[var(--primary)]" aria-label="Cart" data-tippy-content="Cart" data-tippy-placement="bottom">
                    <svg class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
