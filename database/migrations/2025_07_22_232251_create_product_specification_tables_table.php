...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('product_specification_table_group', function (Blueprint $table) {
            $table->foreignId('product_specification_table_id')->constrained()->onDelete('cascade');
            $table->foreignId('product_specification_group_id')->constrained()->onDelete('cascade');
